...
public class A5_Frame extends JFrame implements ActionListener{
	...
	public A5_Frame() {
		...
		title0.setFont(new Font("Serif",0,20));
		...
		add(mypanel0);
		setTitle("进制转换程序");
		//setBounds(40, 600, 500, 400);
		setBounds(1960, 600, 500, 400);
